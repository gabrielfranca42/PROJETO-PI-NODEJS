// Service generated from MunicipioService.java
const db = require('../models');
const NotFoundError = require('../utils/NotFoundError');

const Model = db.MunicipioModel;

const MunicipioDto = require('../dtos/MunicipioDto');
...
class MunicipioService {
  ...
  modelParaDto(model) {
    ...
    return new MunicipioDto(data).toPlain();
  }
