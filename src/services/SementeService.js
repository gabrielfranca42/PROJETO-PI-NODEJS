// Service generated from SementeService.java
const db = require('../models');
const NotFoundError = require('../utils/NotFoundError');

const Model = db.SementeModel;

const SementeDto = require('../dtos/SementeDto');
...
class SementeService {
  ...
  modelParaDto(model) {
    ...
    return new SementeDto(data).toPlain();
  }
...
module.exports = new SementeService();
