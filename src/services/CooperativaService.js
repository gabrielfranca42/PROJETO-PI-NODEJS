// Service generated from CooperativaService.java
const db = require('../models');
const NotFoundError = require('../utils/NotFoundError');

const Model = db.CooperativaModel;

const CooperativaDto = require('../dtos/CooperativaDto');
...
class CooperativaService {
  ...
  modelParaDto(model) {
    ...
    return new CooperativaDto(data).toPlain();
  }
